...
public:
  ...
  virtual void updateFootprint(double robot_x, double robot_y, double robot_yaw, double* min_x, double* min_y, double* max_x, double* max_y);
...
private:
  ...
  std::vector <point_stamp> points;  //array for marked points and their registration time
